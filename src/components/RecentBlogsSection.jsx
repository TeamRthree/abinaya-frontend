  ...
  return (
    <section className="py-12 px-4  md:px-10 bg-white">
      <div className="w-5xl mx-auto">
        <h2 className="text-[#E73C7E] text-[36px] font-medium text-center mb-4">
          Blogs
        </h2>
        <p className="text-center text-[20px] text-[#26346C]/70 max-w-2xl mx-auto mb-10">
    ...
    boxShadow: '0 0 10px rgba(0, 0, 0, 0.2)', // x=0, y=0 → all-around glow
        ...
        {/* Button */}
        <div className="flex justify-center mt-[90px] text-center group">
          <Link
            to="/blogs"
            className="bg-[#FF56A6] flex items-center gap-3 text-[18px] text-[#FEFEFE] px-4 py-3 rounded-[6px] border hover:border-[#FF56A6] hover:text-[#FF56A6] hover:bg-transparent transition-all duration-300 ease-in-out"
          >
            More Blogs <div>
