...
const Testimonials = () => {
  ...
  return (
    <section className="w-full pb-20 pt-[93px] px-4 md:px-8 bg-white text-[#3A405B]">
      <h2 className="text-center text-3xl md:text-[36px] font-medium text-[#E64771] mb-10">
        Our Happy Clients
      </h2>

      <div className="max-w-2xl mx-auto relative flex flex-col items-center gap-10">
          ...
          >
            <div className="bg-white p-6 md:p-8 rounded-xl shadow-lg border border-gray-100 w-full h-full flex flex-col">
              <div className="flex items-center justify-between gap-4">
                ...
                />
                  <p className="font text-[20px]">{activeTestimonial.name}</p>
                  
                </div>
                <div className="flex flex-col gap-2">
<div className="flex items-center gap-1 text-[24px] text-[#FFAC33] mt-1">
                    {[...Array(5)].map((_, i) =>
                ...
                <p className="ml-auto font-light text-sm text-gray-400">
                  {activeTestimonial.date}
                </p>
                </div>
                
              </div>
              <p className="mt-4 text-sm md:text-base text-[#3A405B]/70 opacity-80 leading-[130%]">
