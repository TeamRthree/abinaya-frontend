...
<BookAppointmentForm/>
    ...
    boxShadow: '0 0 20px rgba(0, 0, 0, 0.2)', // x=0, y=0 → all-around glow
      ...
      className="bg-white rounded-xl text-center px-4 py-9">
        <h3 className="text-[#E64771] text-[32px] font-bold mb-1">Location</h3>
        <p className="text-[20px] text-[#3A405B]/70 leading-snug">
    ...
    boxShadow: '0 0 20px rgba(0, 0, 0, 0.2)', // x=0, y=0 → all-around glow
      ...
      className="bg-white rounded-xl text-center px-4 py-9">
        <h3 className="text-[#E64771] text-[32px] font-bold mb-1">Opening Hours</h3>
        <div className='flex items-center justify-center gap-10'>
          <div>
<p className="text-[20px] text-[#3A405B]/70 leading-snug font-bold">Mon to Sat</p>
<p className="text-[20px] text-[#3A405B]/70 leading-snug">7 AM - 9 PM</p>
        </div>
        <div>
<p className="text-[20px] text-[#3A405B]/70 leading-snug font-bold">Sun</p>
<p className="text-[20px] text-[#3A405B]/70 leading-snug">8 AM - 1 PM</p>
        </div>
        </div>
    ...
    boxShadow: '0 0 20px rgba(0, 0, 0, 0.2)', // x=0, y=0 → all-around glow
      ...
      className="bg-white rounded-xl text-center px-4 py-9">
        <h3 className="text-[#E64771] text-[32px] font-bold mb-1">Contact</h3>
        <p className="text-[20px] text-[#3A405B]/70 leading-snug mb-1">
          +91 93423 89585
        </p>
        <p className="text-[20px] text-[#3A405B]/70">doctor@sairamclinic.com</p>
      </div>
    </div>
      </div>
    </div>
